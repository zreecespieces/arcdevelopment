...
const vision = "static/assets/vision.svg";
const consultation = "static/assets/consultationIcon.svg";
const mockup = "static/assets/mockupIcon.svg";
const review = "static/assets/reviewIcon.svg";
const design = "static/assets/designIcon.svg";
const build = "static/assets/buildIcon.svg";
const launch = "static/assets/launchIcon.svg";
const maintain = "static/assets/maintainIcon.svg";
const iterate = "static/assets/iterateIcon.svg";
        ...
        >
          ...
          <Grid item lg style={{ alignSelf: "center" }}>
            <LazyLoadImage
              ...
              src={section.icon} // use normal <img> attributes as props
              width="100%"
            />
          </Grid>
        </Grid>
